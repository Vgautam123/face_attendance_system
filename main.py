...
class App:
    def __init__(self):
        ...
        self.main_window.geometry("1100x520+100+50")
    ...
    def register_newuser(self):
        ...
        self.register_newuser_window.geometry("1100x520+120+70")
        ...
        self.text_label_register_newuser =get_text_label(self.register_newuser_window ,"Please, \nInput username: ")
